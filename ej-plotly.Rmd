...
### `r emojifont::emoji("jack_o_lantern")` ggplot2 + plotly `r emojifont::emoji("jack_o_lantern")`

```{r setup, include=FALSE}
knitr::opts_chunk$set(echo = TRUE, message = FALSE, warning = FALSE)
```

1. `r emo::ji("japanese_goblin")` Cargamos los paquetes
...
5. `r emo::ji("witch")` plotly! creamos un gráfico interactivo con la función ggplotly

```{r}
ggplotly(gg_horror)
```

6. `r emo::ji("japanese_ogre")` Halloween? usaremos el paquete emojifont para incluir emojis en los datos
